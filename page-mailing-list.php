            ...
            <form action="https://occ.emailsp.com/Frontend/subscribe.aspx" id="newsletterForm">
                ...
                <div class="mailing-list-submit">
                    ...
                    <div class="inputs clearfix submitButton">
                        <input class="button button-style-1" onClick="return VerifyRequiredFields();" value="Submit" name="Submit" type="submit">
                    </div>
                    <!-- inputs -->
                </div>
                <!-- mailing-list-submit -->
                <div class="mailText"><p><em>Thanks for joining our email list to receive timely information from Bonnie Raitt. <br> Join the <a href="https://members.bonnieraitt.com/Identity/Account/Register">Fan Community here</a> to be able to purchase pre-sale tickets and Special Benefit Seats from BonnieRaitt.com.</em></p></div>
            </form>
        </div>
